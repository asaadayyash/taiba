<footer class="bg-[#0A0A0A] border-t border-[#2A2A2A] mt-20">
  <div class="max-w-7xl mx-auto px-6 py-16">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
      <div>
        ...
        <p class="text-[#666] text-sm leading-relaxed">Crafting luxury gold jewelry with unmatched quality since 1995.</p>
        <div class="flex items-center gap-3 mt-4">
          <a href="#" class="p-2 text-[#666] hover:text-[#C9A840] transition-colors">
      ...
      <div>
        <h4 class="text-[#C9A840] font-semibold mb-4 text-sm uppercase tracking-wider">Shop</h4>
        <ul class="space-y-2">
          <?php foreach (getCategories() as $cat): ?>
          <li><a href="/taiba-store/products.php?category=<?= e($cat['slug']) ?>" class="text-[#666] text-sm hover:text-[#C9A840] transition-colors"><?= e($cat['name']) ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div>
        <h4 class="text-[#C9A840] font-semibold mb-4 text-sm uppercase tracking-wider">Information</h4>
        <ul class="space-y-2">
          <?php foreach (['About Us','Shipping Policy','Return Policy','Privacy Policy'] as $item): ?>
          <li><a href="#" class="text-[#666] text-sm hover:text-[#C9A840] transition-colors"><?= $item ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div>
        <h4 class="text-[#C9A840] font-semibold mb-4 text-sm uppercase tracking-wider">Contact</h4>
        <ul class="space-y-3 text-sm text-[#666]">
    ...
    <div class="border-t border-[#2A2A2A] mt-12 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
      <p class="text-[#444] text-xs">&copy; <?= date('Y') ?> Taiba Gold Store. All rights reserved.</p>
      <p class="text-[#444] text-xs">Prices include 15% VAT</p>
    </div>
  </div>
</footer>
</body>
